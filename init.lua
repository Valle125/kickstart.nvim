...
-- Paste without loosing the copy
...
end, { desc = 'Harpoon Select File 7' })
vim.keymap.set('n', '<leader>8', function()
  harpoon:list():select(8)
end, { desc = 'Harpoon Select File 8' })
vim.keymap.set('n', '<leader>9', function()
  harpoon:list():select(9)
end, { desc = 'Harpoon Select File 9' })
vim.keymap.set('n', '<leader>0', function()
  harpoon:list():select(10)
end, { desc = 'Harpoon Select File 10' })
...
vim.keymap.set('n', '<leader>cc', function()
  ...
  local output = vim.fn.system('cmake -S ' .. dir .. ' -G "Unix Makefiles" -B build')
  print(output)
